...
- Different citations for websites and where they get their information and data.
...
1. Describe the key differences between the Creative Commons Zero v1.0 Universal, Open Source MIT License, and Open Source GPL License.
  Creative commons is used to credit and recognize contributors to a program or intellectual property. The open source MIT license permissive software license that allows users to do virtually anything with the software and associated documentation files. Open source GPL license allows for copying, modification and redistribution of open source software.
...
Qualcomm is a major contributer to the open-source Android system. They share their technology, making them important to Android devices. Red Hat makes money with Red Hat Enterprise Linux. They offer support and services, adding value to the free Linux software. Both companies show how open source can drive their business success.
...
Companies that use free software still need money to keep going. So, they make cash by offering extra services or by selling better versions of the free software with more features. Some use two kinds of licenses—one free and one you pay for. Others make money by helping with the software, selling extra features, or giving a basic version for free and charging for extra features. 
...
Working in groups provides legal protection, encourages collaboration, and sets expectations of the quality of work for how your work can be shared and improved. The CPT project should allow collaboration and inspiration from different sources in order to improve the final product's quality. This relates to the broader themes of legal and ethic concerns in computing as it may cross into the border of plagarism when taking inspiration or collaborating with a group. 